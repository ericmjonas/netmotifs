...
model. We term our model the ``infinite spatial-relational model''. 
...
There have existed a range of previous approaches to the discovery of
...
quantitative anatomy across animals, and the search for the causes of
...
latent class, $c_i=m$ and $c_j=n$, via a parameter$\eta_{mn}$, as well
